...
# Title: UHD RX DPSK
# Generated: Thu Mar 29 14:42:39 2018
##################################################
...
class RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address='addr=192.168.10.5', freq=2.45e9, freq_offset=0, gain=0, samp_rate=400e3):
        ...
        # Blocks
        ##################################################
        self._tun_freq_range = Range(freq-0.05e9, freq+0.05e9, 1, freq, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/eric/Desktop/out.txt', False)
...
def argument_parser():
    ...
    parser.add_option(
        "-a", "--address", dest="address", type="string", default='addr=192.168.10.5',
